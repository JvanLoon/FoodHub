...
public class UpdateRecipeNameCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, ILogger<UpdateRecipeNameCommandHandler> logger) : IRequestHandler<UpdateRecipeNameCommand, ErrorOr<RecipeDto>>
{
