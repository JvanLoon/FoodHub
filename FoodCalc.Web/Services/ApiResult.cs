...
public class ApiResult
{
    ...
    public static ApiResult Ok(int statusCode) => new()
    {
        Success = true,
    ...
    public static ApiResult Fail(IReadOnlyList<string> errors, int statusCode) => new()
    {
        Success = false,
        Errors = errors,
        StatusCode = statusCode
...
public class ApiResult<T> : ApiResult
{
    ...
    public static ApiResult<T> Ok(T data, int statusCode) => new()
    {
        Success = true,
        Data = data,
        StatusCode = statusCode
    ...
    public static new ApiResult<T> Fail(IReadOnlyList<string> errors, int statusCode) => new()
    {
        Success = false,
        Errors = errors,
        StatusCode = statusCode
